...
urlpatterns = [
    ...
    path('bids/<int:bid_id>/contingency/create', views.create_contingency, name='create-contingency'),
    path('bids/<int:bid_id>/contingency/', views.contingency_detail, name='contingency-detail'),
